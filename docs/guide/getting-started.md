...
Starling has not been fully tested on Windows, but single-agent non-cluster applications should be compatible.
...
Starling has not be tested on MAC OS, so there is no guarantee that it is functional. However in theory the single-agent non-cluster application should be compatible.
...
1. **Step 1:** *Single Drone testing on local machine using Docker only*
    - Follow the following [user guide](/guide/single-drone-local-machine)
...
2. **Step 2:** *Single Drone testing on local cluster*
    - Follow the following [user guide](/guide/kube-single-drone-local-machine)
...
3. **Step 3:** *Single Drone flying at the Robotics Laboratory*
    - Follow the following [user guide](/guide/single-drone-drones)
...
2. **Step 2:** *Multiple Drone testing on local cluster*
    - Follow the following [user guide](/guide/multiple-drone-local-machine.md)
...
3. **Step 3:** *Multiple Drones flying at the Robotics Laboratory*
    - Follow the following [user guide](/guide/multiple-drone-drones)
    - Detailing how to run your controller on real drones at the Bristol Robotics Laboratory
